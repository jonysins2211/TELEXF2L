...
FQDN = getenv("FQDN", "https://telexoriginals-f2l-752b6ad01819.herokuapp.com/") or BIND_ADDRESS  # Full domain name or fallback to bind address
PORT_SEGMENT = "" if NO_PORT else f":{PORT}/"  # Port in URL if not disabled
PROTOCOL = "https" if HAS_SSL else "http"  # Protocol for URL
URL = f"https://telexoriginals-f2l-752b6ad01819.herokuapp.com/"  # Final generated base URL
